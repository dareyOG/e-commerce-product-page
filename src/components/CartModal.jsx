...
function CartModal({ cartList }) {
  return (
    <>
      ...
      <section className='fixed left-[50%] top-[25%] z-20 mx-auto flex h-[23rem] w-[80%] translate-x-[-50%] flex-col rounded-[1.5rem] border-0 bg-neutral-white shadow-2xl lg:absolute lg:right-[-60rem] lg:top-[7.5rem] lg:w-[35rem]'>
